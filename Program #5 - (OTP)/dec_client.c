 ...
 *         		 and use that to decrypt messages through the client side.
 *********************************************************************************/
...
int main(int argc, char *argv[]) {
  ...
  // Turn on the reusable PORT
	...
	char check_dec[] = "dec_client";									// Create a string to check if the server connection is correct
	sprintf(buffer, "%s$%s$%s", text, key, check_dec);			// Combine the message together
